...
<div class="container">		
	<div class="row privacy">
        ...
        <h4 class="page-heading">Lorem ipsum dolor integer sed arcu</h4>
        ...
        <h4 class="page-heading">Molestias excepturi sint</h4>
        ...
        <h4 class="page-heading">Vehicula sem ut volutpat</h4>
        ...
        <h4 class="page-heading"><em>Vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis</em></h4>
        <ul>
