...
<div class="container portfolio-item"> 	
	<div class="row">
        ...
        <div class="col-lg-7 col-md-6 widget">

            <!-- Carousel -->
            <div class="carousel slide bs-docs-carousel-example" id="carousel-example-captions">
        ...
        <div class="col-lg-5 col-md-6 widget">
        	<h3 class="page-heading">Portfolio Item Information</h3>
            ...
            <p><a class="btn btn-f btn-lg" href="#">VISIT THE PROJECT</a></p>
        </div>
    </div><!--/row-->
    ...
    <div class="row">
        <!-- Recent Works -->
        <div class="col-lg-12">
            <h3 class="page-heading">Recent Works</h3>
