...
<div class="container">		
	<div class="row blog-page blog-item">
        ...
        <div class="col-lg-9 col-md-8 col-sm-12 pagebar">
            ...
            <!-- Media -->
            <h3 class="page-heading">Comments</h3>
            <div class="media">
                <a class="pull-left" href="#">
                    <img class="media-object img-thumbnail" src="assets/img/sliders/elastislide/2.jpg" alt="" />
                </a>
                ...
                <p>Donec id elit non mi porta gravida at eget metus. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Etiam porta sem malesuada magna mollis euismod. Donec sed odio dui. </p>
                    ...
                    <div class="media">
                        <a class="pull-left" href="#">
                            <img class="media-object img-thumbnail" src="assets/img/sliders/elastislide/5.jpg" alt="" />
                        </a>
                        <div class="media-body">
                    ...
                    <div class="media">
                        <a class="pull-left" href="#">
                            <img class="media-object img-thumbnail" src="assets/img/sliders/elastislide/11.jpg" alt="" />
                        </a>
                        <div class="media-body">
            ...
            <div class="media">
                <a class="pull-left" href="#">
                    <img class="media-object img-thumbnail" src="assets/img/sliders/elastislide/9.jpg" alt="" />
                </a>
                <div class="media-body">
            ...
            <!-- Leave a Comment -->
            <h3 class="page-heading">Leave a Comment</h3>
