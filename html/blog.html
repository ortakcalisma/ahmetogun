            ...
            <div class="navbar-collapse collapse navbar-responsive-collapse navbar-right">
                <ul class="nav navbar-nav">
                    <li>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="page_home4.html">Option3: Item Slider</a></li>
                ...
                <div class="search-open">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn"><button type="button" class="btn btn-f">Go!</button></span>
                    </div>
                </div>
            </div><!-- /navbar-collapse -->
        </div><!-- /navbar-inner -->
...
<div class="container">		
	<div class="row blog-page">
        <!-- Left Sidebar -->
    	<div class="col-lg-9 col-md-8 col-sm-12 pagebar">
        	<div class="blog">
                ...
                <p><a class="btn btn-link blog-readmore" href="blog_item.html">Read More <i class="icon-chevron-right"></i></a></p>
                <ul class="list-unstyled list-inline blog-info">
                    <li class="blog-type"><i class="icon-file-alt"></i></li>
                    <li><em>in</em> <a href="#">Technology</a> / <a href="#">Education</a></li>
                    <li><em>by</em> <a href="#">Flaty</a></li>
                    <li>02 Feb 2013</li>
                    <li class="blog-comments-number"><a href="#">24 <em>Comments</em></a></li>
                </ul>
            </div><!--/blog-->

        	<div class="blog">
                <div class="blog-img"><img src="assets/img/posts/2.jpg" alt="" /></div>
                <h2><a href="#">Consectetur adipiscing elit similique</a></h2>
                ...
                <p><a class="btn btn-link blog-readmore" href="blog_item.html">Read More <i class="icon-chevron-right"></i></a></p>
                <ul class="list-unstyled list-inline blog-info">
                    <li class="blog-type"><i class="icon-picture"></i></li>
                    <li><em>in</em> <a href="#">Technology</a></li>
                    <li><em>by</em> <a href="#">Flaty</a></li>
                    <li>30 Jan 2013</li>
                    <li class="blog-comments-number"><a href="#">12 <em>Comments</em></a></li>
                </ul>
            </div><!--/blog-->

        	<div class="blog">
                <div class="blog-img"><img src="assets/img/posts/3.jpg" alt="" /></div>
                <h2><a href="#">Blanditiis praesentium voluptatum deleniti</a></h2>
                ...
                <p><a class="btn btn-link blog-readmore" href="blog_item.html">Read More <i class="icon-chevron-right"></i></a></p>
                <ul class="list-unstyled list-inline blog-info">
                    <li class="blog-type"><i class="icon-play-circle"></i></li>
                    <li><em>in</em> <a href="#">Music</a></li>
                    <li><em>by</em> <a href="#">Flaty</a></li>
                    <li>15 Jan 2013</li>
                    <li class="blog-comments-number"><a href="#">5 <em>Comments</em></a></li>
                </ul>
            </div><!--/blog-->

            <div class="text-center">
                <ul class="pagination pagination-f">
    	...
    	<div class="col-lg-3 col-md-4 col-sm-12 sidebar">
            <div class="widget">
                ...
                <form role="form" class="form-search">
                    ...
                    <button type="button" class="btn btn-search"><i class="icon icon-search"></i></button>
                </form>
            </div>

            <div class="widget">
                <!-- Categories -->
                <div class="headline"><h4 class="title">Categories</h4></div>
            ...
            <div class="widget">
                <!-- Recent Posts -->
                <div class="headline"><h4 class="title">Recent Blog Entries</h4></div>
                <ul class="media-list latest-posts">
                    ...
                    <li class="media">
                        <a href="#" class="pull-left"><img src="assets/img/sliders/elastislide/8.jpg" alt="" class="media-object"/></a>
                        <div class="media-body">
                            <p class="post-title"><a href="#">Standard Post Format</a></p>
                            <p class="post-info"><a href="#">15 Jan 2013</a></p>
                        </div>
            ...
            <div class="widget">
                <!-- Tabs Widget -->
                <div class="headline"><h4 class="title">Tabs Widget</h4></div>
                <ul class="nav nav-tabs nav-tabs-f">
                    <li class="active"><a href="#home" data-toggle="tab">First Tab</a></li>
                    <li><a href="#profile" data-toggle="tab">Second Tab</a></li>
                </ul><!--/tabs-->

                <div class="tab-content tab-content-f">
            ...
            <div class="widget">
                <!-- Photo Stream -->
                <div class="headline"><h4 class="title">Photo Stream</h4></div>
            ...
            <div class="widget">
                <!-- Blog Tags -->
                <div class="headline"><h4 class="title">Blog Tags</h4></div>
            ...
            <div class="widget">
                ...
                <div class="blog-twitter">
                    <div class="headline"><h4 class="title">Latest Tweets</h4></div>
                    ...
                    <p><a href="">@flaty</a> At vero eos et accusamus et iusto odio dignissimos. <a href="#">http://t.co/f58Ddg4</a> <span>8 hours ago</span></p>
